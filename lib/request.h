...
#ifndef __LIB_DUFF_REQUEST_H
#define __LIB_DUFF_REQUEST_H

#include "response.h"

duff_response_t *duff_create_request(const char *url);

duff_package_t **duff_create_request_get_packages(const char *url);

#endif /* __LIB_DUFF_REQUEST_H */
