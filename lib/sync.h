...
#ifndef __LIB_DUFF_SYNC_H
#define __LIB_DUFF_SYNC_H

#include "package.h"

duff_package_t **sync_search(char ***packages, int size);

void sync_install(char ***packages, int size);

#endif /* __LIB_DUFF_SYNC_H */
